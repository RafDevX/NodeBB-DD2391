...
One of the most valuable aspects of this journey for Neil was the opportunity to shadow other group members who had more experience with NodeBB and Docker. Through collaboration and learning from his group members expertise, Neil gained practical insights into these technologies. The other group mates shared their knowledge about configuring and deploying NodeBB within Docker Compose stacks, managing Docker networks, and maintaining containerized applications. As Neil encountered challenges during the implementation phase, he was fortunate to have experienced team members to turn to for guidance. Neil remembers struggling with Docker network configurations and compatibility issues with the database management system, and it was through the groups mentorship that he gained a better understanding of how to overcome these hurdles.
